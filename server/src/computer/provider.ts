...
export type ComputerCapacityLimits = {
...
export interface ComputerProvider {
  ...
  /** Static capacity enforced by this provider, when it has a hard ceiling to report. */
  capacity?(): Promise<ComputerCapacityLimits | undefined>;
